...
export default function Dashboard() {
  ...
  const getStatusColor = (status) => {
    switch(status) {
      ...
      default: return 'bg-yellow-500/10 text-yellow-400 border-yellow-500/20'; // Draft
    }
  };
  ...
  return (
    <div className="max-w-6xl mx-auto pb-12">
      <div className="mb-8 flex justify-between items-end">
        <div>
          <h2 className="text-3xl font-bold text-white mb-2">Content Dashboard</h2>
          <p className="text-gray-400">Track and manage all generated content</p>
        </div>
        <Link 
          to="/build" 
      ...
      <div className="bg-[#111111] border border-[#27272a] rounded-xl overflow-hidden shadow-lg">
        <div className="overflow-x-auto">
          <table className="w-full text-left text-sm">
            <thead className="bg-[#18181b] text-gray-400 border-b border-[#27272a]">
              <tr>
                  ...
                  <tr key={log.id} className="hover:bg-[#18181b]/50 transition">
                    <td className="px-6 py-4">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <p className="text-white font-medium line-clamp-1 max-w-sm" title={log.topic}>{log.topic}</p>
                    ...
                    <td className="px-6 py-4 text-gray-400">
                      <div className="flex flex-col gap-1">
                        <span className="bg-[#27272a] px-2 py-0.5 rounded text-xs w-fit text-gray-300">{log.target_audience || 'N/A'}</span>
